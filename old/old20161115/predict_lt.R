...
group <- 1;tw <- 10;func <- 'multinomial.logic.regression'

# group.model(smart.pos,smart.neg,id.pos,id.neg,func = 'logic.regression',group = 1,rate.pos = 0.25)
